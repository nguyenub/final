...
.on('mouseover', (event, features) => {
  ...
  .on('click',(event,features)=>{
    ...
    if (country){
      ...
      document.getElementById('lineInstructions').innerText="We are exploring the correlation between Happiness Score and these following factors: GDP per Capita, Life Expectancy, Freedom, Life Satisfaction. We are currently exploring these correlations in "+country.Country
    }
  })
